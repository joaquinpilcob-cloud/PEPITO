...
(function () {
  ...
  const STRINGS = {
    es: {
      ...
      about_p1: "Creemos que la alta perfumería no debería ser un lujo inalcanzable. Por eso fraccionamos con cuidado fragancias árabes, de diseñador y de nicho en decants de 5ml — el tamaño perfecto para descubrir, viajar o renovar tu perfume favorito sin comprar el frasco completo.",
      about_p2: "Cada decant se extrae directamente del frasco original, se envasa en atomizadores de calidad y se etiqueta con el nombre exacto de la fragancia. Nada de clones ni imitaciones: solo perfumería original, en el formato que tiene sentido.",
    ...
    en: {
      ...
      about_p1: "We believe fine perfumery shouldn't be an unreachable luxury. That's why we carefully decant Arabian, designer and niche fragrances into 5ml portions — the perfect size to discover, travel with, or refill your favorite scent without buying the full bottle.",
      about_p2: "Every decant is drawn directly from the original bottle, filled into quality atomizers and labeled with the exact fragrance name. No clones, no imitations — only original perfumery, in a format that makes sense.",
